...
<div class="page-content-wrap">
            <div class="row">
             <div class="col-md-12">
             <form class="form-horizontal" method="POST" action="{{url('admin/roles')}}" enctype="multipart/form-data" id="add_service">
                          @csrf
                                        ...
                                        <div class="col-md-6 col-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <input type="text"  name="name" class="form-control" id="name" placeholder="role's name" >                                             
                                            </div>                                            
                                            <span class="help-block"> Role's name</span>  
                                        </div>
                                    </div>
                                </div>
                           ...
                           @foreach ($roles as $t)
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td class="edit">
                                 <a href="{{url('admin/roles').'/'.$t->id.'/edit'}}"> <span class="fa fa-edit"></span></a>
                                 <a href="{{url('admin/roles').'/'.$t->id.'/delete'}} " onclick="return confirm( 'Are you sure that you want to delete this role? ')"> <span class="fas fa-trash-alt"></span></a>
                                </td>
                            </tr>
                    @endforeach
                </tbody>
