...
@endif
  ...
  <div class="panel panel-default">
                                ...
                                <div class="panel-body">            
                                        <a href="{{url('admin/research').'/'.$research->id.'/delete'}} " style="font-size:25px" onclick="return confirm( 'Are you sure that you want to delete this research? ')"> <span class="fa fa-trash-o"></span></a>
